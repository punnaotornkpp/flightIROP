...
@Component({
  ...
  template: ` <div class="card">
    ...
    <div
      class="text-2xl text-surface-900 dark:text-surface-0 mb-6 font-semibold"
    >
    ...
    <p class="leading-normal text-lg mb-6">
      ...
      week “writing” a blog post, but it&lsquo;s important to spend those vital
      hours planning your post and even thinking about Your Post(yes, thinking
      counts as working if you&lsquo;re a blogger) before you actually write it.
    </p>
    <p class="leading-normal text-lg mb-6">
      There&lsquo;s an old maxim that states, “No fun for the writer, no fun for
      the reader.”No matter what industry you&lsquo;re working in, as a blogger,
    ...
    <div class="flex items-center mb-6 font-bold">
      <span class="text-xl text-surface-900 dark:text-surface-0 mr-6"
        >Comments</span
      >
      <span
    ...
    <ul class="list-none p-0 m-0">
      ...
      >
        ...
        <div>
          ...
          <p
            class="font-semibold text-surface-600 dark:text-surface-200 m-0 text-sm"
          >
            {{ comment.date }}
          </p>
    ...
    <div
      class="text-xl text-surface-900 dark:text-surface-0 mb-6 font-bold mt-20"
    >
      Post a Comment
    </div>
