      ...
      <div class="card h-full">
        ...
        <div>
          ...
          <div class="flex align-item-center justify-between">
            <span
              class="text-surface-900 dark:text-surface-0 mt-4 text-md font-medium"
              >{{ metric.files }}</span
            >
            <span
              class="text-surface-900 dark:text-surface-0 mt-4 text-md font-medium"
              >{{ metric.fileSize }}</span
            >
          </div>
        </div>
      </div>
        ...
        <div class="grid grid-cols-12 gap-4">
          ...
          >
            ...
            >
              ...
              <span
                class="text-surface-600 dark:text-surface-200 text-lg font-semibold"
                >{{ folder.size }}</span
              >
            </div>
          </div>
        ...
        >
          <ng-template pTemplate="header">
            <tr>
              ...
              >
                <span class="flex items-center gap-2"
                  >File Size <p-sortIcon field="fileSize"></p-sortIcon
                ></span>
              </th>
