        ...
        <div class="card">
          ...
          <div style="height: 200px; overflow: auto">
            <p>
              ...
              integer. Mattis aliquam faucibus purus in massa tempor nec. Lorem
              ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
              tempor incididunt ut labore et dolore magna aliqua. Vitae et leo
              duis ut diam. Ultricies mi quis hendrerit dolor magna eget est
              lorem. Amet consectetur adipiscing elit ut. Nam libero justo
              laoreet sit amet. Pharetra massa massa ultricies mi quis hendrerit
              dolor magna. Est ultricies integer quis auctor elit sed vulputate.
              Consequat ac felis donec et. Tellus orci ac auctor augue mauris.
              Semper feugiat nibh sed pulvinar proin gravida hendrerit lectus a.
        ...
        <div class="card">
          ...
          <div class="flex items-center flex-col sm:flex-row gap-2">
            ...
            <p-chip label="Asiya Javayant">
              <img
                src="/demo/images/avatar/asiyajavayant.png"
                class="w-8 h-8"
                alt="avatar"
              />
            </p-chip>
            <p-chip label="Onyama Limba">
              <img
                src="/demo/images/avatar/onyamalimba.png"
                class="w-8 h-8"
                alt="avatar"
              />
            </p-chip>
            <p-chip label="Xuxue Feng" [removable]="true">
              <img
                src="/demo/images/avatar/xuxuefeng.png"
                class="w-8 h-8"
                alt="avatar"
              />
            </p-chip>
