...
@Component({
  ...
  template: `<div>
    <block-viewer header="Hero" [code]="block1" free>
      ...
      >
        <div
          class="col-span-12 md:col-span-6 p-12 text-center md:text-left flex items-center"
        >
          <section>
      ...
      >
        ...
        <div class="grid grid-cols-12 gap-4">
          <div class="col-span-12 md:col-span-4 mb-6 px-8">
            ...
            <div
              class="text-surface-900 dark:text-surface-0 text-xl mb-4 font-medium"
            >
    ...
    <block-viewer header="Pricing" [code]="block3" free>
      <div
        class="bg-surface-50 dark:bg-surface-950 px-6 py-20 md:px-12 lg:px-20"
      >
        <div
          class="text-surface-900 dark:text-surface-0 font-bold text-6xl mb-6 text-center"
        >
          Pricing Plans
        </div>
        <div
        ...
        <div class="grid grid-cols-12 gap-4">
          <div class="col-span-12 lg:col-span-4">
            <div class="p-4 h-full">
              ...
              >
                <div
                  class="text-surface-900 dark:text-surface-0 font-medium text-xl mb-2"
                >
                  Basic
                </div>
                ...
                <hr
                  class="my-4 mx-0 border-t border-0 border-surface-200 dark:border-surface-700"
                />
                <div class="flex items-center">
                  <span
                    class="font-bold text-2xl text-surface-900 dark:text-surface-0"
                    >$9</span
                  >
                  <span
                    class="ml-2 font-medium text-surface-600 dark:text-surface-200"
                    >per month</span
                  >
                </div>
                <hr
                ...
                <hr
                  class="mt-auto mb-4 mx-0 border-t border-0 border-surface-200 dark:border-surface-700"
                />
              ...
              >
                ...
                <ul class="list-none p-0 m-0 flex-grow-1">
                  ...
                  <li class="flex items-center mb-4">
                    <i class="pi pi-check-circle text-green-500 mr-2"></i>
                    <span class="text-surface-900 dark:text-surface-0"
                      >Imperdiet proin</span
                    >
                  </li>
                  <li class="flex items-center mb-4">
                    <i class="pi pi-check-circle text-green-500 mr-2"></i>
                    <span class="text-surface-900 dark:text-surface-0"
                      >Nisi scelerisque</span
                    >
                  </li>
                </ul>
                <hr
                  class="mb-4 mx-0 border-t border-0 border-surface-200 dark:border-surface-700"
                />
                <p-button
                  label="Buy Now"
    ...
    <block-viewer
      header="Banner"
      [code]="block5"
      containerClass="bg-surface-0 dark:bg-surface-950 py-20"
      free
    >
      <div
    ...
    <block-viewer header="Page Heading" [code]="block6" free>
      <div class="bg-surface-0 dark:bg-surface-950 px-6 py-8 md:px-12 lg:px-20">
        <ul class="list-none p-0 m-0 flex items-center font-medium mb-4">
          ...
          <li class="px-2">
            <i
              class="pi pi-angle-right text-surface-500 dark:text-surface-300 leading-normal"
            ></i>
          </li>
          <li>
        ...
        <div class="flex items-start flex-col lg:justify-between lg:flex-row">
          <div>
            ...
            <div
              class="flex items-center text-surface-700 dark:text-surface-100 flex-wrap"
            >
          ...
          <div class="col-span-12 md:col-span-6 lg:col-span-3">
            <div class="bg-surface-0 dark:bg-surface-900 shadow p-4 rounded">
              <div class="flex justify-between mb-4">
                ...
                <div
                  class="flex items-center justify-center bg-purple-100 rounded"
                  style="width: 2.5rem; height: 2.5rem"
                >
    ...
    <block-viewer
      header="Sign-In"
      [code]="block8"
      containerClass="bg-surface-50 dark:bg-surface-950 px-6 py-20 md:px-12 lg:px-20 flex items-center justify-center"
      free
    >
      <div
        class="bg-surface-0 dark:bg-surface-900 p-6 shadow rounded w-full lg:w-6/12"
      >
    ...
    <block-viewer
      ...
      [code]="block9"
      containerClass="bg-surface-0 dark:bg-surface-950 px-6 py-20 md:px-12 lg:px-20"
      free
    >
      <div class="bg-surface-0 dark:bg-surface-950">
        <div
          class="font-medium text-3xl text-surface-900 dark:text-surface-0 mb-4"
        >
          Movie Information
        </div>
        ...
        <ul class="list-none p-0 m-0">
          <li
            class="flex items-center py-4 px-2 border-t border-surface-200 dark:border-surface-700 flex-wrap"
          >
            <div
              class="text-surface-500 dark:text-surface-300 w-6/12 md:w-2/12 font-medium"
            >
              Title
            </div>
            <div
          ...
          <li
            class="flex items-center py-4 px-2 border-t border-b border-surface-200 dark:border-surface-700 flex-wrap"
          >
            <div
              class="text-surface-500 dark:text-surface-300 w-6/12 md:w-2/12 font-medium"
            >
    ...
    <block-viewer
      header="Card"
      [code]="block10"
      containerClass="px-6 py-20 md:px-12 lg:px-20"
      free
    >
