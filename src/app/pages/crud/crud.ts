    ...
    >
      <ng-template #content>
        <div class="flex flex-col gap-6">
          ...
          <div>
            <label for="description" class="block font-bold mb-4"
              >Description</label
            >
            <textarea
              id="description"
          ...
          <div>
            <label for="inventoryStatus" class="block font-bold mb-4"
          ...
          <div class="grid grid-cols-12 gap-4">
            ...
            <div class="col-span-6">
              <label for="quantity" class="block font-bold mb-4"
                >Quantity</label
              >
              <p-inputnumber
                id="quantity"
