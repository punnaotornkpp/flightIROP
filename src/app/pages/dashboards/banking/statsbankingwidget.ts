  ...
  template: `
    ...
    <div class="col-span-12 md:col-span-6 xl:col-span-4">
      <div class="card h-full">
        ...
        <div class="text-surface-600 dark:text-surface-200 mb-1 font-semibold">
          Debt
        </div>
        <div class="text-2xl text-primary mb-8 font-bold">$1.500,00</div>
        <div class="flex items-center justify-between">
          <span class="text-surface-900 dark:text-surface-0 text-lg"
            >**** **** **** 1231</span
          >
          <span
            class="text-surface-600 dark:text-surface-200 font-medium text-lg"
            >12/24</span
          >
        </div>
      </div>
    ...
    <div class="col-span-12 md:col-span-6 xl:col-span-2">
      <div class="card h-full flex flex-col items-center justify-center">
        ...
        <span
          class="text-surface-900 dark:text-surface-0 text-lg mb-6 font-medium"
          >Primary</span
        >
