...
@Component({
  ...
  template: `
    <div
      class="grid grid-cols-12 gap-4 card grid-nogutter"
    ...
    >
      ...
      <div
        class="col-span-12 mt-4 h-80 border border-surface p-0 w-full bg-cover rounded-border"
        [ngStyle]="mapStyle"
      ></div>
      <div class="col-span-12 mt-8">
        ...
        >
          ...
          >
            ...
            <span
              class="text-surface-900 dark:text-surface-0 font-bold mt-6 mb-1"
              >{{ item.title }}</span
            >
      ...
      <div class="col-span-12 mt-8">
        ...
        >
          <div class="col-span-6 flex flex-col">
            <label for="name" class="block font-bold text-surface-500"
              >Name</label
            >
          ...
          <div class="col-span-6 flex flex-col">
            <label for="email" class="block font-bold text-surface-500"
              >Email Address</label
            >
            <p-icon-field class="mt-2" [style]="{ height: '3.5rem' }">
              <p-inputicon
          ...
          <div class="col-span-12 flex flex-col">
            <label for="message" class="block font-bold text-surface-500"
              >Message</label
            >
            <textarea
              id="message"
              rows="5"
              pTextarea
              class="w-full mt-2 border-surface p-12 text-surface-900 dark:text-surface-0 font-semibold rounded-border"
              [autoResize]="true"
              [(ngModel)]="message"
            ></textarea>
            <button
              pButton
              class="p-button-primary ml-auto mt-4 rounded-border"
              label="Send Message"
            ></button>
          </div>
        </div>
...
export class ContactUs {
  ...
  get mapStyle() {
    return {
      'background-image': this.layoutService.isDarkTheme()
        ? "url('/demo/images/contact/map-dark.svg')"
        : "url('/demo/images/contact/map-light.svg')",
    };
  }
}
