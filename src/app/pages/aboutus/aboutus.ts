    ...
    <div class="card px-6 py-20 md:px-12 lg:px-20">
      <div class="flex flex-wrap mb-6">
        ...
        <div class="w-full lg:w-6/12 pr-0 lg:pl-6 mt-4 lg:mt-0">
          <div
            class="font-bold text-4xl mb-6 text-surface-900 dark:text-surface-0"
          >
            About us
          </div>
      ...
      <div class="mt-4 md:mt-20">
        <span
          class="block text-surface-900 dark:text-surface-0 font-bold text-3xl mb-4 text-center"
          >Our Team</span
        >
        <div class="text-center text-lg leading-normal mb-12">
          Faucibus ornare suspendisse sed nisi. Nisl rhoncus mattis rhoncus urna
          neque viverra justo nec.
        </div>
        <div class="grid grid-cols-12 gap-4">
          <div
            *ngFor="let member of teamMembers; let i = index"
            class="col-span-12 md:col-span-6 lg:col-span-3 p-4"
          >
            <div
              class="relative overflow-hidden"
              (mouseenter)="setVisibleMember(i)"
            ...
            >
              ...
              >
                <div class="flex flex-col p-8 h-full">
                  <span class="block font-medium text-white text-xl mb-4">{{
                    member.name
                  }}</span>
                  <span
                    class="font-medium text-surface-400 dark:text-surface-400"
                    >{{ member.role }}</span
                  >
                  <div class="mt-auto">
                    <a
                      *ngFor="let socialIcon of member.socialIcons"
                      tabindex="0"
                      class="cursor-pointer text-white"
                    >
                      <i
                        [ngClass]="socialIcon.iconClass"
                        [class]="socialIcon.additionalClasses"
                      ></i>
                    </a>
                  </div>
                </div>
