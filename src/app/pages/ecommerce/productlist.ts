...
@Component({
  ...
  template: `
    <div class="card">
      <div
        class="text-surface-900 dark:text-surface-0 font-medium text-4xl mb-6"
      >
        Popular Products
      </div>
        ...
        >
          <div class="p-2">
            <div class="shadow p-6 bg-surface-0 dark:bg-surface-900 rounded">
              ...
              <p
                class="mt-0 mb-4 text-surface-700 dark:text-surface-100 leading-normal"
              >
    ...
    <div class="card">
      <div class="grid grid-cols-12 gap-4 -mt-4 -ml-4 -mr-4">
        <div
          class="col-span-12 md:col-span-6 lg:col-span-3 mb-8 lg:mb-0"
          *ngFor="let product of products2"
        >
          ...
          <div class="flex flex-col items-center">
            <span
              class="text-xl text-surface-900 dark:text-surface-0 font-medium mb-4"
              >Product Name</span
            >
            <span class="text-xl text-surface-900 dark:text-surface-0 mb-4"
              >$150.00</span
            >
