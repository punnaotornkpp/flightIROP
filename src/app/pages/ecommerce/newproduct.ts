      ...
      <p-fluid class="grid grid-cols-12 gap-4 flex-wrap">
                ...
                <ng-template #content>
                  ...
                  >
                    ...
                    >
                      ...
                      <span
                        class="block font-semibold text-surface-900 dark:text-surface-0 text-lg"
                    ...
                    >
                      <div
                        *ngFor="let file of product.images; let i = index"
                      ...
                      >
                        <div
                          class="remove-file-wrapper relative w-full h-60 border-4 border-transparent rounded hover:bg-primary hover:text-primary-contrast duration-100 cursor-auto"
                          [style]="{ padding: '1px' }"
                        >
                          <img
                            [src]="file.objectURL"
        ...
        <div class="col-span-12 lg:col-span-4 flex flex-col gap-y-4">
          ...
          >
            ...
            <div class="p-4">
              <div
                class="bg-surface-100 dark:bg-surface-700 py-2 px-4 flex items-center rounded"
              >
                <span class="text-black/90 dark:!text-surface-0 font-bold mr-4"
                  >Status:</span
                >
                <span class="text-black/60 dark:!text-surface-0 font-semibold"
                  >Draft</span
                >
                <button
                  pButton
          ...
          >
            ...
            <div class="p-4 flex flex-wrap gap-1">
              ...
              >
                ...
                <span
                  class="flex w-4 h-4 items-center justify-center border border-surface-200 dark:border-surface-700 bg-gray-100 rounded-full cursor-pointer"
                  (click)="onChipRemove(tag)"
                >
                  <i
                    class="pi pi-fw pi-times text-black/60"
                    style="font-size: 9px"
                  ></i>
                </span>
              </p-chip>
            ...
            <div class="p-4 flex">
              ...
              >
                <i
                  ...
                  *ngIf="product.colors.indexOf(color.name) !== -1"
                ></i>
              </div>
            </div>
          </div>
          ...
          >
            <span class="text-surface-900 dark:text-surface-0 font-bold p-4"
              >In stock</span
            >
