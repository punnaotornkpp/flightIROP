  ...
  template: `
    <div class="card">
      <div class="flex flex-col items-center mb-12">
        <div
          class="text-surface-900 dark:text-surface-0 text-4xl mb-6 font-medium"
        >
          Your cart total is $82.00
        </div>
        <p
          class="text-surface-700 dark:text-surface-100 font-medium text-xl mt-0 mb-6"
        >
          ...
          <div class="flex-auto py-8 md:pl-8">
            ...
            >
              <div class="w-full sm:w-6/12 flex flex-col">
                <span
                  class="text-surface-900 dark:text-surface-0 text-xl font-medium mb-4"
                  >Product Name</span
                >
              ...
              <div
                class="w-full sm:w-6/12 flex items-start justify-between mt-4 sm:mt-0"
              >
                <div>
                ...
                <div class="flex flex-col sm:items-end">
                  <span
                    class="text-surface-900 dark:text-surface-0 text-xl font-medium mb-2 sm:mb-4"
                    >$20.00</span
                  >
                  <a
            ...
            <div class="flex flex-col">
              <span class="inline-flex items-center mb-4">
                <i
                  class="pi pi-envelope text-surface-700 dark:text-surface-100 mr-2"
                ></i>
              ...
              <span class="inline-flex items-center mb-4">
                <i
                  class="pi pi-send text-surface-700 dark:text-surface-100 mr-2"
                ></i>
                <span class="text-surface-700 dark:text-surface-100 mr-2">
                  Delivery by
              ...
              <span class="flex items-center">
                <i
                  class="pi pi-exclamation-triangle text-surface-700 dark:text-surface-100 mr-2"
                ></i>
                <span class="text-surface-700 dark:text-surface-100"
                  >Only 8 Available.</span
                >
              </span>
            </div>
          </div>
      ...
      <div class="flex">
        ...
        <ul class="list-none py-0 pr-0 pl-0 md:pl-8 mt-12 mx-0 mb-0 flex-auto">
          <li class="flex justify-between mb-6">
            <span
              class="text-xl text-surface-900 dark:text-surface-0 font-semibold"
              >Subtotal</span
            >
          ...
          >
            <span
              class="text-surface-900 dark:text-surface-0 font-bold text-3xl"
              >Total</span
            >
            <span
              class="text-surface-900 dark:text-surface-0 font-bold text-3xl"
