    ...
    <div class="card">
      <div class="flex flex-col md:flex-row justify-between items-center mb-6">
        <div class="flex flex-col text-center md:text-left">
          <span class="text-surface-900 dark:text-surface-0 text-2xl mb-2"
            >My Orders</span
          >
          <span class="text-surface-600 dark:text-surface-200 text-lg"
            >Dignissim diam quis enim lobortis.</span
          >
        </div>
      ...
      >
        <div
          class="col-span-12 flex p-2 bg-surface-100 dark:bg-surface-700 rounded-t"
        >
          <div class="p-2 flex-auto text-center md:text-left">
            ...
            >
            <span
              class="text-surface-900 dark:text-surface-0 font-medium block mt-2"
          ...
          <p-divider
            align="center"
            layout="vertical"
            styleClass="h-full mx-0 lg:mx-4 border-surface-200 dark:border-surface-700"
          ></p-divider>
          <div class="p-2 flex-auto text-center md:text-left">
            <span class="text-surface-700 dark:text-surface-100 block"
              >Order Date</span
        ...
        <div class="col-span-12">
          ...
          >
            <div
              class="flex flex-col lg:flex-row justify-center items-center px-2"
            >
              <img
                [src]="product.image"
                alt="product"
              ...
              <div class="flex flex-col my-auto text-center md:text-left">
                <span
                  class="text-surface-900 dark:text-surface-0 font-medium mb-4 mt-4 lg:mt-0"
                  >{{ product.name }}</span
                >
                <span
                  class="text-surface-700 dark:text-surface-100 text-sm mb-4"
                ...
                <a
                  ...
                  >Buy Again
                  <span class="font-light">| {{ product.price }}</span></a
                >
              </div>
            </div>
            <div
            ...
            <p-divider
              *ngIf="i !== order.products.length - 1"
              class="w-full !block lg:!hidden border-surface-200 dark:border-surface-700"
            ></p-divider>
          </div>
        </div>
        <div
          class="col-span-12 p-0 flex border-t border-surface-200 dark:border-surface-700"
        >
          <a
            tabindex="0"
