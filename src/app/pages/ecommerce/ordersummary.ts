...
@Component({
  ...
  template: `
    <div class="card">
      <span class="text-surface-700 dark:text-surface-100 text-xl"
        >Thanks!</span
      >
      ...
      <div
        class="flex flex-col sm:flex-row sm:items-center sm:justify-between py-8"
      >
        <div class="mb-4 sm:mb-0">
          <span
            class="font-medium text-xl text-surface-900 dark:text-surface-0 mr-2"
            >Order number:</span
          >
        ...
        <ul class="list-none p-0 m-0">
          ...
          >
            ...
            <div class="flex flex-col">
              <span
                class="text-surface-900 dark:text-surface-0 font-semibold text-xl mb-2"
                >{{ product.name }}</span
              >
              <span
                class="text-surface-700 dark:text-surface-100 font-medium mb-4"
                >{{ product.color }} | {{ product.size }}</span
              >
            ...
            <span
              class="text-surface-900 dark:text-surface-0 font-medium text-lg ml-auto"
              >{{ product.price }}</span
            >
          </li>
        </ul>
      ...
      <div class="flex flex-wrap mt-8 pb-4">
        <div class="w-full lg:w-6/12 pl-4">
          ...
          >
          <div
            class="flex flex-col text-surface-900 dark:text-surface-0 mt-4 mb-8"
          >
        ...
        <div
          class="w-full lg:w-6/12 pl-4 lg:pl-0 lg:pr-4 flex items-end mt-8 lg:mt-0"
        >
          <ul class="list-none p-0 m-0 w-full">
            ...
            <li class="flex justify-between mb-4">
              ...
              <span
                class="text-surface-900 dark:text-surface-0 font-medium text-lg"
                >$36.00</span
              >
            </li>
            <li class="flex justify-between mb-4">
            ...
            >
              ...
              >
              <span
                class="text-surface-900 dark:text-surface-0 font-bold text-lg"
                >$41.00</span
              >
            </li>
          </ul>
    ...
    <div class="card">
      <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center">
        ...
        <div class="flex mt-4 sm:mt-0">
          <div class="flex flex-col items-center">
            <span class="text-surface-900 dark:text-surface-0 font-medium mb-2"
              >Order ID</span
            >
      ...
      >
        ...
        <div class="flex-auto mt-4 md:mt-0">
          <span class="text-xl text-surface-900 dark:text-surface-0"
            >Product Name</span
          >
          <div
            class="font-medium text-2xl text-surface-900 dark:text-surface-0 mt-4 mb-8"
          >
            Order Processing
          </div>
          <div
          ...
          >
            <div
              class="bg-primary text-primary-contrast rounded w-4/12 h-full"
            ></div>
          </div>
          <div class="flex w-full justify-between">
            <span
              class="text-surface-900 dark:text-surface-0 text-xs sm:text-base"
              >Ordered</span
            >
            <span
              class="text-surface-900 dark:text-surface-0 font-medium text-xs sm:text-base"
              >Processing</span
            >
            <span
              class="text-surface-500 dark:text-surface-300 text-xs sm:text-base"
              >Shipping</span
            >
            <span
              class="text-surface-500 dark:text-surface-300 text-xs sm:text-base"
      ...
      <div class="py-8 flex justify-between flex-wrap">
        <div class="flex sm:mr-8 mb-8">
          <span
            class="font-medium text-surface-900 dark:text-surface-0 text-xl mr-20"
            >Product Name</span
          >
          <span class="text-surface-900 dark:text-surface-0 text-xl"
            >$21.00</span
          >
        </div>
