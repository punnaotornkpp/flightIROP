    ...
    <div class="card">
      <div class="grid grid-cols-12 gap-4 mb-16">
        <div class="col-span-12 lg:col-span-7">
          <div class="flex">
            <div
              class="flex flex-col w-2/12 justify-between"
              style="row-gap: 1rem;"
            >
              <img
            ...
            <div class="pl-4 w-10/12 flex">
              <img
                src="/demo/images/ecommerce/productoverview/{{
        ...
        <div class="col-span-12 lg:col-span-4 py-4 lg:pl-12">
          ...
          <div class="flex flex-wrap items-center justify-between mb-8">
            <span
              class="text-surface-900 dark:text-surface-0 font-medium text-3xl block"
              >$120</span
            >
            <div class="flex items-center">
              <span class="mr-4 flex-shrink-0">
                ...
                <i class="pi pi-star-fill text-yellow-500 mr-1"></i>
                <i
                  class="pi pi-star text-surface-600 dark:text-surface-200 mr-1"
                ></i>
              </span>
              <span class="text-sm">
                <b class="text-surface-900 dark:text-surface-0 mr-1">24</b>
                <span class="text-surface-500 dark:text-surface-300"></span
                >reviews
              </span>
            </div>
          </div>
          ...
          <div class="flex items-center mb-8">
            <div
              ...
              [style.box-shadow]="
                color === 'bluegray' ? '0 0 0 0.2rem var(--p-gray-500)' : null
              "
            ...
            <div
              ...
              [style.box-shadow]="
                color === 'green' ? '0 0 0 0.2rem var(--p-green-500)' : null
              "
              (click)="color = 'green'"
            ></div>
            <div
              ...
              [style.box-shadow]="
                color === 'blue' ? '0 0 0 0.2rem var(--p-blue-500)' : null
              "
              (click)="color = 'blue'"
            ></div>
          </div>
          ...
          <div
            class="flex flex-col sm:flex-row items-start sm:items-center flex-wrap gap-4"
          >
            <p-inputNumber
              [showButtons]="true"
      ...
      <p-tabs value="0">
        ...
        <p-tabpanels>
          <p-tabpanel value="0">
            <div
              class="text-surface-900 dark:text-surface-0 font-bold text-3xl mb-6 mt-2"
            >
              Product Details
            </div>
            <p
              class="leading-normal text-surface-600 dark:text-surface-200 p-0 mx-0 mt-0 mb-6"
            >
              ...
              scelerisque viverra mauris in. Viverra justo nec ultrices dui
              sapien eget mi proin. Laoreet suspendisse interdum consectetur
              libero id faucibus.
            </p>
            ...
            <div class="grid grid-cols-12 gap-4">
              <div class="col-span-12 lg:col-span-4">
                <span
                  class="text-surface-900 dark:text-surface-0 block mb-4 font-bold"
                  >Highlights</span
                >
                <ul
                  class="py-0 pl-4 m-0 text-surface-600 dark:text-surface-200 mb-4"
                >
              ...
              <div class="col-span-12 lg:col-span-4">
                ...
                >
                <ul
                  class="list-none p-0 m-0 text-surface-600 dark:text-surface-200 mb-6"
                >
                  <li class="mb-4">
              ...
              <div class="col-span-12 lg:col-span-4">
                ...
                >
                  <li
                    class="flex items-center whitespace-nowrap w-40 mr-2 mb-4"
                  >
                    <i
                      class="pi pi-sun mr-2 text-surface-900 dark:text-surface-0"
                    ></i>
                    <span>Not dryer safe</span>
                  </li>
                  <li class="flex items-center whitespace-nowrap w-40 mb-4">
                    <i
                      class="pi pi-times-circle mr-2 text-surface-900 dark:text-surface-0"
                    ></i>
                    <span>No chemical wash</span>
                  </li>
                  <li
                    class="flex items-center whitespace-nowrap w-40 mb-4 mr-2"
                  >
                    <i
                      class="pi pi-sliders-h mr-2 text-surface-900 dark:text-surface-0"
                    ></i>
                    <span>Iron medium heat</span>
                  </li>
                  <li class="flex items-center whitespace-nowrap w-40 mb-4">
                    <i
                      class="pi pi-minus-circle mr-2 text-surface-900 dark:text-surface-0"
                    ></i>
                    <span>Dry flat</span>
                  </li>
                </ul>
          ...
          <p-tabpanel value="1">
            ...
            <ul class="list-none p-0 m-0">
              <li
                class="pb-8 border-b border-surface-200 dark:border-surface-700"
              >
                <span>
                  <i class="pi pi-star-fill text-yellow-500 mr-1"></i>
                  <i class="pi pi-star-fill text-yellow-500 mr-1"></i>
                ...
                <div
                  class="text-surface-900 dark:text-surface-0 font-bold text-xl my-4"
                >
                  Absolute Perfection!
                </div>
                <p
                  class="mx-0 mt-0 mb-4 text-surface-600 dark:text-surface-200 leading-normal"
                >
                  ...
                  proin fermentum leo vel orci porta non. Porttitor rhoncus
                  dolor purus non.
                </p>
                <span class="font-medium">Darlene Robertson, 2 days ago</span>
              </li>
              <li
                class="py-8 border-b border-surface-200 dark:border-surface-700"
              >
                <span>
                  <i class="pi pi-star-fill text-yellow-500 mr-1"></i>
                  <i class="pi pi-star-fill text-yellow-500 mr-1"></i>
          ...
          <p-tabpanel value="2">
            ...
            >
              ...
              Justo donec enim diam vulputate ut pharetra. Tempus egestas sed
              sed risus. Feugiat sed lectus vestibulum mattis. Tristique nulla
              aliquet enim tortor at auctor urna nunc. Habitant morbi tristique
            ...
            <div class="grid grid-cols-12 gap-4">
              <div class="col-span-12 md:col-span-6">
                <span
                  class="text-surface-900 dark:text-surface-0 block font-bold mb-4"
                  >Shipping Costs</span
                >
                <ul
                  class="py-0 pl-4 m-0 text-surface-600 dark:text-surface-200 mb-4"
              ...
              <div class="col-span-12 md:col-span-6">
                ...
                >
                <p
                  class="leading-normal text-surface-600 dark:text-surface-200 p-0 m-0"
                >
                  Pharetra et ultrices neque ornare aenean euismod elementum
                  nisi. Diam phasellus vestibulum lorem sed. Mattis molestie a
                  iaculis at.
                </p>
              </div>
            </div>
