    ...
    <div class="card">
      <div class="grid grid-cols-12 gap-4 grid-nogutter">
        <div class="col-span-12 px-6 mt-6 md:mt-12 md:px-12">
          <span
            class="text-surface-900 dark:text-surface-0 block font-bold text-xl"
            >Checkout</span
          >
        </div>
        <div class="col-span-12 lg:col-span-6 h-full px-6 py-6 md:px-12">
          <ul class="flex list-none flex-wrap p-0 mb-12">
            ...
            <li
              class="flex items-center text-surface-500 dark:text-surface-300 mr-2"
            >
              Information<i
                class="pi pi-chevron-right text-surface-500 dark:text-surface-300 text-xs ml-2"
              ></i>
          ...
          <div class="grid grid-cols-12 gap-4">
            <div class="col-span-12 mb-12">
              <span
                class="text-surface-900 dark:text-surface-0 text-2xl block font-medium mb-8"
              ...
              <div class="flex items-center">
                <p-checkbox
                  ...
                  inputId="id"
                ></p-checkbox>
                <label class="ml-2" for="checkbox-1"
            ...
            <div class="col-span-12 lg:col-span-6 mb-6">
              <div class="flex items-center">
                <p-checkbox
                  ...
                  inputId="id"
                ></p-checkbox>
                <label class="ml-2" for="checkbox-2"
        ...
        <div class="col-span-12 lg:col-span-6 px-6 py-6 md:px-12">
          ...
          <div
            class="py-2 mt-4 bg-yellow-100 flex items-center justify-center rounded"
          >
            <img
